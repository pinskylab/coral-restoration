...
trait_strategy = 'variance' #What traits to send? Options: 'value', 'variance', 'percentile'
value = 25 #For value strategy
scaling_frac = 0.5 #For variance strategy
percentile = 50 #For percentile strategy
source_cover = np.array([1.0,1.0]) #Sets the fractional cover at restoration source sites
