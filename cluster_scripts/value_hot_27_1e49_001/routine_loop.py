...
if __name__ == '__main__':
    ...
    for seed in seed_values:
        ...
        for j in range(0, len(P.source_cover)):
            for y in range(0, len(P.value)):
                for l in range(0, len(P.V)):
                    ...
                    #! BURN-IN
                    spp_state_restore[-num_restore:,:] = P.source_cover[j]
                    trait_state_restore[-num_restore,:] = np.repeat(P.value[y],P.nsp)
                    ...
                    np.save("N0_"+P.trait_strategy+"_"+P.strategy+"_"+str(P.value[y])+"_"+str(P.source_cover[j][0])+"_"+str(P.V[l][0])+"_"+str(seed)+".npy", N0)
                    np.save("Z0_"+P.trait_strategy+"_"+P.strategy+"_"+str(P.value[y])+"_"+str(P.source_cover[j][0])+"_"+str(P.V[l][0])+"_"+str(seed)+".npy", Z0)
                    np.save("SST0"+P.trait_strategy+"_"+P.strategy+"_"+str(P.value[y])+"_"+str(P.source_cover[j][0])+"_"+str(P.V[l][0])+"_"+str(seed)+".npy", SST_burnin)

                    np.save("N1_"+P.trait_strategy+"_"+P.strategy+"_"+str(P.value[y])+"_"+str(P.source_cover[j][0])+"_"+str(P.V[l][0])+"_"+str(seed)+".npy", N1)
                    np.save("Z1_"+P.trait_strategy+"_"+P.strategy+"_"+str(P.value[y])+"_"+str(P.source_cover[j][0])+"_"+str(P.V[l][0])+"_"+str(seed)+".npy", Z1)
                    np.save("SST1_"+P.trait_strategy+"_"+P.strategy+"_"+str(P.value[y])+"_"+str(P.source_cover[j][0])+"_"+str(P.V[l][0])+"_"+str(seed)+".npy", SST_runtime)
